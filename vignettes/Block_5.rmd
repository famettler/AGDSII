...
```
Precipitation, on the other hand, differs less than before scaling, but still shows some destinct patterns
```{r}
group_folds_train <- purrr::map(
